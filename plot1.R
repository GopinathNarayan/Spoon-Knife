...
#Generating Plot-1 on Windows screen
#The first plot, Histogram of Global Active Power
hist(HPCSubset$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
